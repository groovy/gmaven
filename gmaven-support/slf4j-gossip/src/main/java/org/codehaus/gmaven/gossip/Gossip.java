...
package org.codehaus.gmaven.gossip;

import org.codehaus.gmaven.gossip.config.Configurator;
import org.codehaus.gmaven.gossip.model.EffectiveProfile;
    ...
    implements ILoggerFactory
{
    ...
    private void prime() {
        ...
        for (Iterator iter = profile.loggers().entrySet().iterator(); iter.hasNext();) {
            ...
            org.codehaus.gmaven.gossip.model.Logger node =
                    (org.codehaus.gmaven.gossip.model.Logger)entry.getValue();
