...
public interface ClassFactory
    extends Component
{
    String KEY = ClassFactory.class.getName();
    ...
    Class create(String className, ClassLoader classLoader, ResourceLoader resourceLoader) throws Exception;

    Class create(String className, ClassLoader classLoader) throws Exception;
}
