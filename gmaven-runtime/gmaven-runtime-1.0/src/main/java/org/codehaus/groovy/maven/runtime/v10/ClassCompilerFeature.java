 ...
 *                   role-hint="org.codehaus.groovy.maven.runtime.ClassCompiler"
 *
 * @version $Id$
        ...
        implements ClassCompiler, ClassCompiler.Keys
    {
        ...
        public URL[] getClassPath() {
            if (classPath == null || classPath.length == 0) {
                throw new IllegalStateException("Class-path not bound, or is empty");
            }
        ...
        public int compile() throws Exception {
            ...
            log.debug("Compiling {} source(s)", String.valueOf(sources.size()));
            ...
            if (log.isDebugEnabled()) {
                log.debug("Compiled {} class(es):", String.valueOf(classes.size()));
